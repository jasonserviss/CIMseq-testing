...
load('~/Github/CIMseq.testing/analysis/visualizingPoissonAlgo/data/syntheticMultiplets.rda')
...
ggsave(
  plot = p1,
  filename = '~/Github/CIMseq.testing/analysis/visualizingPoissonAlgo/figures/figure1.pdf',
  device = cairo_pdf,
  height = 180,
  width = 120,
  units = "mm"
...
ggsave(
  plot = p2,
  filename = '~/Github/CIMseq.testing/analysis/visualizingPoissonAlgo/figures/figure2.pdf',
  device = cairo_pdf,
  height = 180,
  width = 240,
  units = "mm"
...
ggsave(
  plot = p,
  filename = '~/Github/CIMseq.testing/analysis/visualizingPoissonAlgo/figures/figure.pdf',
  device = cairo_pdf,
  height = 180,
  width = 240,
  units = "mm"
