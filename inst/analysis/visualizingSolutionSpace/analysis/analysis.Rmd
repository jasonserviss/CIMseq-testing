...
#DATA
load('~/Github/CIMseq.testing/inst/analysis/visualizingSolutionSpace/data/report.rda')
```
...
ggsave(
  plot = p,
  filename = '~/Github/CIMseq.testing/inst/analysis/visualizingSolutionSpace/figures/figure2.pdf',
  device = cairo_pdf,
  height = 240,
  width = 240,
  units = "mm"
