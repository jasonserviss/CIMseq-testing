...
#spSwarm
sObj_distToSlice <- spSwarm(cObjMul, uObj, distFun = "distToSlice", swarmsize = 500, maxiter = 100)
sObj_distToSliceNorm <- spSwarm(cObjMul, uObj, distFun = "distToSliceNorm", swarmsize = 500, maxiter = 100)
sObj_distToSliceTop <- spSwarm(cObjMul, uObj, distFun = "distToSliceTop", swarmsize = 500, maxiter = 100, cells = 4)
sObj_distToSliceEuclid <- spSwarm(cObjMul, uObj, distFun = "distToSliceEuclid", swarmsize = 500, maxiter = 100)
sObj_distToSlicePearson <- spSwarm(cObjMul, uObj, distFun = "distToSlicePearson", swarmsize = 500, maxiter = 100)
sObj_bic <- spSwarm(cObjMul, uObj, distFun = "bic", swarmsize = 500, maxiter = 100)
```
