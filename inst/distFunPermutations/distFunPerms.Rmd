...
#sObj_distToSliceNorm <- spSwarm(cObjMul, uObj, distFun = "distToSliceNorm", swarmsize = 500, maxiter = 10)
#sObj_distToSliceTop <- spSwarm(cObjMul, uObj, distFun = "distToSliceTop", swarmsize = 500, maxiter = 10, cells = 4)
#sObj_distToSliceEuclid <- spSwarm(cObjMul, uObj, distFun = "distToSliceEuclid", swarmsize = 500, maxiter = 10)
#sObj_distToSlicePearson <- spSwarm(cObjMul, uObj, distFun = "distToSlicePearson", swarmsize = 500, maxiter = 10)
```
