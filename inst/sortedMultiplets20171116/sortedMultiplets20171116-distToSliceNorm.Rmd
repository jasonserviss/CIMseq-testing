---
title: "sortedMultiplets20171116-distToSliceNorm"
...
#spSwarm
sObj <- spSwarm(cObjMul, uObj, distFun = "distToSliceNorm", swarmsize = 50, maxiter = 10)
...
getData(sObj, "costs") %>%
  as_tibble() %>%
  ggplot() +
  geom_histogram(aes(x = value), binwidth = 5000) +
  theme_few()
```
